...
public class EncryptsMultiCatalogTransform extends AbstractMultiCatalogMapTransform {

    public EncryptsMultiCatalogTransform(
    ...
    protected SeaTunnelTransform<SeaTunnelRow> buildTransform(
        ...
        return new EncryptTransform(config, inputCatalogTable);
    }
}
