...
public class FlussConnectorException extends SeaTunnelRuntimeException {

    private boolean reCreateLabel;

    public FlussConnectorException(SeaTunnelErrorCode seaTunnelErrorCode, String errorMessage) {
    ...
    public FlussConnectorException(SeaTunnelErrorCode seaTunnelErrorCode, Throwable cause) {
