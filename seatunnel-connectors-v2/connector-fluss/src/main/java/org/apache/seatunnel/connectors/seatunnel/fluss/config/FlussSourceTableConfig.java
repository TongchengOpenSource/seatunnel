...
@Getter
public class FlussSourceTableConfig implements Serializable {
    ...
    private FlussSourceTableConfig(
    ...
    public static FlussSourceTableConfig parseStarRocksSourceConfig(ReadonlyConfig config) {
        ...
        return new FlussSourceTableConfig(
                table, catalogTable, config.get(StarRocksSourceOptions.SCAN_FILTER));
    }

    public static List<FlussSourceTableConfig> of(ReadonlyConfig config) {
        ...
        if (config.getOptional(StarRocksSourceOptions.TABLE_LIST).isPresent()) {
            ...
            return maps.stream()
                    ...
                    .map(FlussSourceTableConfig::parseStarRocksSourceConfig)
