...
public class FlussSourceFactory implements TableSourceFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(
                        FlussBaseOptions.BOOTSTRAP_SERVERS,
                        FlussBaseOptions.DATABASE)
                .optional(
                        SinkConnectorCommonOptions.SCHEMA,
                        FlussBaseOptions.USERNAME,
                        FlussBaseOptions.PASSWORD)
                .exclusive(FlussBaseOptions.TABLE, FlussSourceOptions.TABLE_LIST)
                .build();
    }
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        SourceConfig flussSourceConfig = new SourceConfig(config);
        return () ->
                (SeaTunnelSource<T, SplitT, StateT>) new FlussSource(flussSourceConfig);
    }
}
