...
package org.apache.seatunnel.connectors.seatunnel.fluss.schema;
...
import org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType;
import org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussTypeConverter;
...
public class SchemaUtils {
    ...
    public static void applySchemaChange(
        ...
        BasicTypeDefine<FlussType> typeDefine =
                FlussTypeConverter.INSTANCE.reconvert(event.getColumn());
        StringBuilder sqlBuilder =
                new StringBuilder()
                        .append("ALTER TABLE")
                        .append(" ")
