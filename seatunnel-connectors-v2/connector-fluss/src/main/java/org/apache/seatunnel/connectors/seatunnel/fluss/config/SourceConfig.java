...
@Setter
@Getter
public class SourceConfig extends FlussConfig {
    ...
    public SourceConfig(ReadonlyConfig config) {
        ...
        this.tableConfigList = FlussSourceTableConfig.of(config);
    }
    ...
    private List<FlussSourceTableConfig> tableConfigList = new ArrayList<>();
