...
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.BIGINT;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.BOOLEAN;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.CHAR;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.DATE;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.DECIMAL;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.DOUBLE;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.FLOAT;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.INT;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.NULL;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.SMALLINT;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.SR_DATETIME;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.STRING;
import static org.apache.seatunnel.connectors.seatunnel.fluss.datatypes.FlussType.TINYINT;


/** Starrocks type converter for catalog. */
@Slf4j
@AutoService(TypeConverter.class)
public class FlussTypeConverter implements TypeConverter<BasicTypeDefine<FlussType>> {
    ...
    public static final FlussTypeConverter INSTANCE = new FlussTypeConverter();
    ...
    @Override
    public Column convert(BasicTypeDefine<FlussType> typeDefine) {
    ...
    @Override
    public BasicTypeDefine<FlussType> reconvert(Column column) {
        BasicTypeDefine.BasicTypeDefineBuilder<FlussType> builder =
                BasicTypeDefine.<FlussType>builder()
                        .name(column.getName())
            ...
            case DECIMAL:
                ...
                if (precision <= 0) {
                    ...
                    log.warn(
                            ...
                            MAX_PRECISION);
                    builder.dataType(STRING);
                    builder.columnType(String.format("%s(%s)", STRING, 200));
                    break;
                }
    ...
    private void setDecimalType(
            PhysicalColumn.PhysicalColumnBuilder builder,
            BasicTypeDefine<FlussType> typeDefine) {
        Long p = 10L;
        int scale = 0;
    ...
    private String getOriginalType(BasicTypeDefine<FlussType> typeDefine) {
    ...
    private void reconvertString(
            Column column, BasicTypeDefine.BasicTypeDefineBuilder<FlussType> builder) {
        // source is doris too.
