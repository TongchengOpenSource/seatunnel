...
class OffsetsInitializerTest {
    ...
    void testEarliestOffsetsInitializer() {
        ...
        Map<Integer, Long> offsets =
                initializer.getBucketOffsets(TEST_PARTITION, TEST_BUCKETS, retriever);
    ...
    void testFromStartupMode() {
        ...
        OffsetsInitializer earliest =
                OffsetsInitializer.fromStartupMode(StartupMode.EARLIEST, null);
        ...
        long timestamp = 1678883047356L;
        OffsetsInitializer timestampInit =
                OffsetsInitializer.fromStartupMode(StartupMode.TIMESTAMP, timestamp);
    ...
    private static class MockBucketOffsetsRetriever
