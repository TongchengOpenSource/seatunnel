...
public class MilvusIT extends TestSuiteBase implements TestResource {
    ...
    @TestTemplate
    public void testToMilvusWithMultipletable(TestContainer container) throws IOException, InterruptedException {
        Container.ExecResult execResult = container.executeJob("/milvus-to-assert-with-multipletable.conf");
        Assertions.assertEquals(0, execResult.getExitCode());
    }
}
